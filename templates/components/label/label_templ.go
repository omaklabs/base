...
func classes(p Props) string {
	return shared.Cx("block text-sm text-muted-foreground mb-1.5", p.Class)
}

// Label renders a form field label. Zero-arg call gives unstyled label.
func Label(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/components/label/label.templ`, Line: 1, Col: 0}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/components/label/label.templ`, Line: 26, Col: 40}
		}
